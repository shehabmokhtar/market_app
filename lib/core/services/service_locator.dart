...
class ServiceLocator {
  void init() {
    serviceLocator
        .registerSingleton<AuthanticationCubit>(AuthanticationCubit());
    serviceLocator.registerSingleton<BannersRepo>(BannersRepo());
    serviceLocator.registerSingleton<BannersCubit>(BannersCubit());
    serviceLocator.registerSingleton<AddAddressCubit>(AddAddressCubit());
    serviceLocator.registerSingleton<AddAddressRepo>(AddAddressRepo());
  }
}
